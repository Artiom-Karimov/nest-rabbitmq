...
export class AMQPPublishService implements OnModuleInit {
  ...
  public onModuleInit(): void {
    ...
    // Must be bound, othrwise you won't know anything
  ...
  public async publish({ routingKey, content }: Message): Promise<void> {
    try {
      ...
      throw error; // This is necessary because transaction success may depend on publishing
    }
  }
  ...
  private async setupChannel(channel: ConfirmChannel): Promise<void> {
    ...
    try {
      ...
      */
      ...
      this.logger.error('Cannot create exchange', error);
    }
  }
}
